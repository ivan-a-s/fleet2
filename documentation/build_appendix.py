...
def render_general():
    ...
    lines = [
        ...
        _row("Nest scale - Liquid",                   _get(D, "fleet",    "nest_lambdas", "liquid")),
        _row("Nest scale - Conventional",             _get(D, "fleet",    "nest_lambdas", "conventional")),
        _row("Nest scale - Hydrogen",                 _get(D, "fleet",    "nest_lambdas", "hydrogen")),
        _row("Nest scale - Electric",                 _get(D, "fleet",    "nest_lambdas", "electric")),
...
def render_fuel_properties():
    ...
    fuels = [
        ...
        ("public_slow_charge", "Electricity (public slow charge)", "kWh"),
...
def render_powertrain_params():
    ...
    lines = [
        ...
        _row("Battery capacity (sleeper / day-cab / straight)",
             Param(f"{_val(be_cap_sleeper)} / {_val(be_cap_daycab)} / {_val(be_cap_straight)}",
                   src="Table 15"), "kWh"),
