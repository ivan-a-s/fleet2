...
files = {
    'Base': '../Results/Base Case.pkl',
    'Base + BM': '../Results/Break Mandate.pkl',
    'Policy Package - BM': '../Policy Package (no break mandate).pkl',
...
for label, fname in files.items():
    ...
    percent = 100 - total_fuel[:, -1]/(total_fuel[:, 0]/1.3448) * 100
